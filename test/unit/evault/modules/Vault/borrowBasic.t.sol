...
contract VaultTest_BorrowBasic is EVaultTestBase {
    ...
    function test_borrow_VerySmallInterest() public {
        ...
        skip(1);
        assertEq(eTST.interestAccumulator(), 1.000000003170979198376458650e27);
        ...
        assertEq(eTST.debtOf(borrower), 0.500000001585489600e18);
        assertApproxEqAbs(eTST.debtOfExact(borrower), debtExact(0.500000001585489599188229324e27), 0.00000000000000001e18);

...
contract CryticToFoundry is Invariants, Setup {
    ...
    function test_BASE_INVARIANT1() public {// PASS
    ...
    function test_BASE_INVARIANT2() public {// PASS
        _setUpBlockAndActor(25742, USER3);
        this.mintToActor(457584007913129639927, 115792089237316195423570985008687907853269984665640564039457584007913129639768);

...
contract CryticToFoundry is Invariants, Setup {
    ...
    function test_BM_INVARIANT3() public {
        ...
        this.setLTV(113884487589860002952951511119799819009743936658790969442180828775288854748777, 40, 40, 0);
        _setUpActor(USER2);
    ...
    function test_TM_INVARIANT_B1() public {
        // PASS
        this.setLTV(72646444105010896140249531445510794379335059401176316902940832566730525333, 1, 1, 0);
    ...
    function test_depositToActor_bug() public {
        ...
        this.setLTV(1804231840195618435650555517191418148400545023790587635103902141215022596, 10, 10, 0);
    ...
    function test_BM_INVARIANT2() public {
        this.setLTV(4928164140911258518180007983958125974735619848025477191374701, 1, 1, 0);
    ...
    function test_BM_INVARIANT7() public {
        this.setLTV(1108761414529882035672596488633488862111302583, 1, 1, 0);

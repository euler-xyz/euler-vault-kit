...
abstract contract InvariantsSpec {
    ...
    string constant BM_INVARIANT_N1 = "BM_INVARIANT_N1: loop(x) => repayWithShares(x) users shouldn't gain any asset";

    string constant BM_INVARIANT_N2 = "BM_INVARIANT_N2: loop(x) => repayWithShares(x) users debt shouldn't decrease";

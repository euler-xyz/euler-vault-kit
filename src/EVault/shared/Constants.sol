...
uint256 constant MAX_SANE_DEBT_AMOUNT = type(uint144).max;
uint256 constant MAX_SANE_SMALL_AMOUNT = type(uint96).max;
uint256 constant INTERNAL_DEBT_PRECISION = 1e9;
...
uint24 constant OP_BORROW = 1 << 5;
uint24 constant OP_REPAY = 1 << 6;
uint24 constant OP_WIND = 1 << 7;
uint24 constant OP_UNWIND = 1 << 8;
uint24 constant OP_PULL_DEBT = 1 << 9;
uint24 constant OP_CONVERT_FEES = 1 << 10;
uint24 constant OP_LIQUIDATE = 1 << 11;
uint24 constant OP_TOUCH = 1 << 12;

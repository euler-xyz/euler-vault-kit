...
contract SwapHandler1Inch is SwapHandlerCombinedBase {
    ...
    constructor(address oneInchAggregator_, address uniSwapRouterV2, address uniSwapRouterV3)
        SwapHandlerCombinedBase(uniSwapRouterV2, uniSwapRouterV3)
    {
        oneInchAggregator = oneInchAggregator_;
    }

    function swapPrimary(SwapParams memory params) internal override returns (uint256 amountOut) {
